...
class starter {
	...
	public static void generateTreasure()
	{
		...
		int rand2 = (int)(Math.random()*map[0].length);
		 
	}
	public static void Map(int r, int c)
	{
		int [][] map = new int [r][c];
	}
	...
	public static void printTreasureLoc()
	{
	...
	public static void move(int rows, int columns)
	{
