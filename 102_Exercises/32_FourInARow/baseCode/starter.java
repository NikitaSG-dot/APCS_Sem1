	...
	// Any spot with an "O" in its place should be disregarded and continued to the next check
 	public static int checkVertical(String[][] board){
 		...
 		for (int r = 0; r < board.length-3; r++)
 		{
 			...
 			{
 				if (board[r][c].equalsIgnoreCase(board[r+1][c]) && board[r+1][c].equalsIgnoreCase(board[r+2][c])&&
 				board[r+2][c].equalsIgnoreCase(board[r+3][c]))
 				{
 					if (board[r][c].equalsIgnoreCase("A"))
 					{
 						return 1;
 					}
 					else if (board[r][c].equalsIgnoreCase("B"))
 					{
 						return 2;
 					}
 				}
		...
		for (int r = 0; r < board.length; r++)
 		{
 			...
 			{
 				if (board[r][c].equalsIgnoreCase(board[r][c+1]) && board[r][c+1].equalsIgnoreCase(board[r][c+2])&&
				board[r][c+2].equalsIgnoreCase(board[r][c+3]))
 				{
 					if (board[r][c].equalsIgnoreCase("A"))
 					{
 						return 1;
